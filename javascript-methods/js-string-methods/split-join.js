...
a character to use to break up the string or a regular expression. 
...
// below code would reverse the str Hello World 
let reverseStr = str
//no space between the double quotesto reverse first split to get individual letters
                    .split("")
                    .reverse()
                    .join("");
...
let newStr = "Hello World,I-am code";
console.log(newStr);

console.log(splitify(newStr));
...
let greetingBe = greeting.join(" new ")
...
let sentenceBe = "May-the-force-be-with-you";
console.log(sentensify(sentenceBe));
...
about reduce, which is a powerful method used to reduce problems to simpler forms. 
...
of the URL for simple bookmarking purposes. For example, if you write a Medium 
post titled Stop Using Reduce it's likely the URL would have some form of the title 
string in it (.../stop-using-reduce). 
...
let slugs = " Winter Is Comming";
console.log(urlSlugs(slugs));