...
The callback function accepts three arguments. The first argument 
is the current element being processed. The second is the index 
of that element and the third is the array upon which the filter 
method was called.
...
let user2 = users.filter((under25 => under25.age <= 25));
console.log(user2);
/**Array(2)
0: {name: "John", lastName: "Doer", age: 23, location: "Edinborough"}
1: {name: "Amy", lastName: "forcast", age: 25, location: "Lincon city"}
length: 2
__proto__: Array(0) */
...
// function string(str) {
//     return{ratings: str[parseInt(["imdbRating"])]}
    
// }
var filteredList = watchList
        .filter(a => a.imdbRating>= 8.0)
        .map(item => ({
            // rating: parseInt(item.imdbRating), code returns number
